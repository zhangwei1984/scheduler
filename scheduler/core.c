...
static int cpu_gang_mask_write_u64(struct cgroup *cgrp, struct cftype *cftype,
                u64 shareval)
{
    return sched_group_set_cpumask(cgroup_tg(cgrp), shareval);
}
static u64 cpu_gang_mask_read_u64(struct cgroup *cgrp, struct cftype *cft)
{
    struct task_group *tg = cgroup_tg(cgrp);

    return (u64) tg->cpumask;
}
...
static struct cftype cpu_files[] = {
    ...
    {
        .name = "cpumask",
        .read_u64 = cpu_gang_mask_read_u64,
        .write_u64 = cpu_gang_mask_write_u64,
    },
#endif
#ifdef CONFIG_CFS_BANDWIDTH
	{
